                                            ...
                                            <form action="cart.php" method="post">
                                                <select name="transporteur">
                                                    ...
                                                    foreach ($transporteur as $key => $data) {
                                                        echo ' <option value="' . $data['price'] . '"> ' . $data['name'] . '  ' . formatprice($data['price']) . "€ ", ' </option>   ';
                                                    }                                                   
                                                    ?>
                                                </select>                                               
                                                <button type="submit" class="btn btn-dark btn-block btn-lg" value="<?php $_POST['transporteur'] =$data['price']; ?>" data-mdb-ripple-color="dark" name="add_transporteur">Valider </button>
                                            </form>                                 
                                        </div>
