...
<div>
    ...
    <p><?php echo  'prix : ' . formatprice($teeshirt["price"]) . ' € ' . '<br>' ?></p>
    <p><?php echo  'prixHT : ' . priceExcludingVAT($teeshirt["price"]) . ' € ' . '<br>' ?></p>
...
<div>
    ...
    <p><?php echo  'prix : ' . formatprice($poster["price"]) . ' € ' . '<br>' ?></p>
    <p><?php echo  'prixHT : ' . priceExcludingVAT($poster["price"]) . ' € ' . '<br>' ?></p>
